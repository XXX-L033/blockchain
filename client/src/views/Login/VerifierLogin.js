...
import GreenFeature from '../BondChecking/GreenFeature';
...
const route = {
    path: `/BondChecking/GreenFeature`,
    component: GreenFeature,
};

const onFinish = (values) =>{
    const jumpForm3 = document.createElement('form');
    document.body.appendChild(jumpForm3);
    jumpForm3.action = `/BondChecking/GreenFeature`;
    jumpForm3.submit();
}
                ...
                <Layout>
                    ...
                    <Content>
                        <div className="site-layout-background" style={{padding: '10px'}}>
                            <Title style={{fontWeight: 'bold', fontSize: 40, textAlign: 'center'}}>Green Verifier
                                Login</Title>
                            <br/>
